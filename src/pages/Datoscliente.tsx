...
interface Negocio {
  ...
  telefono: string;
  portada: string; // Asegúrate de que "portada" esté presente en el modelo
}
...
const DatosCliente = () => {
  ...
  return (
    <div className="container mt-5">
      <h2 className="text-center mb-4">Datos del Cliente</h2>
      <div className="row">
                ...
                <img
                  src={
                    negocio.portada
                      ...
                      //? `http://localhost:3001/uploads/${negocio.idnegocio}/${negocio.portada}`//local
